...
const connectToMongoDB = require('./MongoDBConnect'); // Ensure the path matches the file name
...
app.post('/updatebook/:id', function(req,res){
  ...
  console.log("upate id",id,"newbook->",updatedbook)
  Books.findByIdAndUpdate(id, 
    {
      booktittle:updatedbook.booktittle,
      PubYear:uopdatedbook.PubYear,
    ...
    function(err,docs){
      ...
      res.status(200).json({'book':'book updated sucessfully'});
    }
  }
)
});
